...
public class OrderManageController {
    ...
    @ResponseBody
    public ServerResponse<OrderVo> orderDetail(HttpSession session, Long orderNo, HttpServletRequest request){
    ...
    @ResponseBody
    public ServerResponse<String> orderSendGoods(HttpSession session, Long orderNo,HttpServletRequest request){
